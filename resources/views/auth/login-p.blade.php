            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-warning btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Acceder</button>
                        </div>
                    </div>
                    <div class="form-group m-b-0">
                        <div class="col-sm-12 text-center">
                            <p>Ir a sitio de<a href="{{route('inicio')}}" target="blank" class="text-info m-l-5"><b class="text-warning">tutoriales</b></a></p>
                        </div>
                    </div>
                </form>
            </div>
